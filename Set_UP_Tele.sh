...
#   11. Creates and configures a dedicated update service and three independent
#       application services with a safe, sequential startup order.
#   12. Creates a desktop application shortcut for the "Add Patient" GUI.
#   13. Enables and starts all services.
#   14. Verifies that all services are running.
#
# Usage:
...
# 11. Create Desktop Application Shortcut
# ======================================
...
# 13. Run Initial Screen Check
# ============================
echo "Performing initial check for connected monitors..."
$CHSCREEN_SCRIPT_PATH
echo

# 14. Verify the Service Status
# ===============================
echo "--- Verification ---"
